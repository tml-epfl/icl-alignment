...
if __name__ == "__main__":
    ...
    if args.engine == "vllm":
        ...
        # llm = LLM(model=args.model_name, tokenizer=args.tokenizer_name, tensor_parallel_size=args.tensor_parallel_size, download_dir=args.download_dir, load_format="safetensors", tokenizer_mode=args.tokenizer_mode, trust_remote_code=True)        
